...
const navMenuMob = document.querySelector(".navmenu-mob");
navMenuMob.addEventListener("click", removeNavMenu);

function removeNavMenu(event) {
  if (event.target.classList.contains("navmenu__link")) {
